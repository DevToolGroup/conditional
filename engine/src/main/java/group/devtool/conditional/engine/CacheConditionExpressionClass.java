 ...
 * 规则条件表达式合并为RETE树
 */
public class CacheConditionExpressionClass extends GenericExpressionClass {

  private List<VariableReference> references;

  public CacheConditionExpressionClass() {
    super();
  }

  public CacheConditionExpressionClass(List<Token> tokens) throws RuleClassException {
    super(tokens);
